<?php
/*
Plugin Name: Woocommerce Signifyd
Plugin URI: http://www.supergeek.tech/
Description: Signifyd Integration
Version: 1.0.0
Author: Freddy Rivero
Author URI: http://www.supergeek.tech/
*/
		...
		if ( ! class_exists( 'WC_NxGn_Signifyd' ) ) {
			...
			class WC_NxGn_Signifyd {
				...
				function text_ajax_create_case($order_id) {
						...
						'fullName' => get_post_meta( $post_id, '_billing_first_name', true ).' '.get_post_meta( $post_id, '_billing_last_name', true ),
...
*/
						...
						$request->addUserAccount(array(
								...
								'username' => get_post_meta( $post_id, '_billing_email', true ),
